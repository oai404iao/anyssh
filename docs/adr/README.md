...
| [0016](0016-keyboard-interactive-responses-are-session-bound.md) | Proposed | Keyboard-interactive 响应是 Session-bound 临时秘密 |
...
ADR-0015。ADR-0004、0005、0007 和 0016 因对应能力尚未完整实现而继续保持
Proposed。
